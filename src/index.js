...
// make a hash all values
function MerkleTree (values) {
  // hash values and add to leaves of tree
  const hashes = []
  hashes.push(map(values, v => sha256('' + v)))
...
const values = ['S', 'N', 3, 1, 9, '🐶']
console.log(`Hashing values ${values} into Merkle tree...\n`)
